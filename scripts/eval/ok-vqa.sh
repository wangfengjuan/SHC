...
MODEL_PATH="/home/omnisky/userfile_2/wangfj/TinyLLaVA/checkpoints/llava_factory/tiny-llava-phi-2-siglip-so400m-patch14-384-base-finetune-1115"
MODEL_NAME="tiny-llava-phi-2-siglip-so400m-patch14-384-base-finetune-1115"
